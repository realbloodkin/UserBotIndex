...
class Bot(Client):
    def __init__(self):
        ...
        # Define the admin filter inside the class
...
async def start_handler(client: Bot, message: Message):
    if client.userbot and client.userbot.is_connected:
        ...
        await message.reply_text("👋 **Welcome!**\n\nTo begin, please set your `SESSION_STRING` environment variable and restart the bot to log in the userbot.")
...
async def index_handler(client: Bot, message: Message):
    # This is the full indexer function from your original file
